...
bool BST::searchElement(node* root, int val){
	/*
	First Exit Condition, If Found :
	If Root->Data Itself Is The Value, Return True.

	If Root->Data Less Than Value, And The Next Value To Its Left Branch Is A Nullptr, Return False,
		Else Search The Whole Left Subtree.

	If Root->Data Greater Than Value, And The Next Value To Its Right Branch Is A Nullptr, Return False,
		Else Seach The Whole Right Subtree.

	Second Exit Condition, If Not Found :
	Else Return False.
	*/
	if(root != nullptr)
	{
